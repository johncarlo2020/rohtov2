    ...
    <div class="content-box main-background px-3 d-flex flex-column min-vh-100">
        ...
        <div id="qrContainer" class=" bg-white p-3 rounded d-none">
            <div class="text-center mb-2 px-1">
                ...
                <p class="pharagraph-text text-center">You’re among the first 1,000 sign-ups and eligible to redeem our exclusive Upcycled Marine Phone Charm!</p>
                <br>
            ...
            <p class="sub-heading-text text-center mb-0">Date selected: <span id="selected-date">{{ $selectedAppointment->appointment->name ?? '' }}</span>, {{ $convertedDate ustom
            }} <br/> Venue: IOI City Mall,
