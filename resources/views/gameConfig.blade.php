        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="maxValueInput" class="form-label">Max Gauge Value in decimal</label>
                            <input type="number" class="form-control" id="maxValueInput" step="0.1"
                                value="{{ $config->max_weight ?? 4 }}" oninput="updateMaxValue()">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="incrementInput" step="10"
                                value="{{ $config->increment_grams ?? 100 }}" oninput="updateIncrement()">
