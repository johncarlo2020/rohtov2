...
@section('content')
                ...
                <div class="control-buttons text-center">
                    ...
                    <div class="kibble-preset-box mb-2">
                        ...
                        <div class="kibble-preset-buttons mt-2">
                            ...
                            <button type="button" class="kibble-preset-btn" data-count="6"
                                onclick="setKibbleCount(6)">6</button>
                            <button type="button" class="kibble-preset-btn active" data-count="12"
                                onclick="setKibbleCount(12)">12</button>
                    ...
                    <div class="reset-button-area mt-3 d-none" id="resetButtonArea">
                        <button class="btn btn-reset rounded-pill mobile-friendly-btn" id="resetButton"
                            onclick="resetGame()">
    ...
    <script>
        ...
        // Reflect connection state as a green/red dot next to the heading
        const connectionDot = document.getElementById('connectionDot');

        function updateConnectionDot(state) {
            const isConnected = state === 'connected';
            connectionDot.classList.toggle('connected', isConnected);
            connectionDot.title = isConnected ? 'Connected' : state.charAt(0).toUpperCase() + state.slice(1);
        }
        pusher.connection.bind('state_change', (states) => updateConnectionDot(states.current));
        updateConnectionDot(pusher.connection.state);
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (oldMaxWeight !== maxWeight || oldIncrement !== incrementGrams) {
                        console.log('Configuration updated - Max Weight:', maxWeight, 'kg, Increment:', incrementGrams,
                            'g');
                    }
