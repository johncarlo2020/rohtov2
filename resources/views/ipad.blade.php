<x-app-layout>
    ...
    <div class="antialiased ipad-background h-100 ipad-page">
                    ...
                    <div class="d-block">
                        <form id="weightForm">
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-2 mb-4">
                                ...
                                <img src="{{ asset('images/brand/rc_scale_img.png') }}" alt="scale"
                                ...
                                <!-- G Box -->
                                <span class="bg-danger text-white rounded-2 px-3 py-1 fw-bold"
                                    style="font-size:30px;">G</span>
                            </div>
        ...
        <!-- Thank You Modal -->
        <div class="modal modal-sm fade" id="thankYouModal" tabindex="-1" aria-labelledby="thankYouModalLabel"
            aria-hidden="true">
