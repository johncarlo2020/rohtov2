                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-7 text-start mb-3">
                            ...
                            <small style="font-size:12px;">
                                ...
                                we’ve expanded globally. This year, our "SAVE the BLUE" project will operate in eight countries, 
                            ...
                            <div class="modal-dialog modal-dialog-centered w-75 m-auto">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="d-block gap-3">
                                        <button id="modalYesBtn" type="button" class="custom-btn custom-btn-primary w-50 mb-3">
                                        Yes
                                        </button>
                                        <button type="button" class="custom-btn custom-btn-secondary w-50" data-bs-dismiss="modal" aria-label="Close">
                                        No
                                        </button>
                                    </div>
                                    </div>
                        ...
                        <div class="col mt-5 animate-entry delay-2">
                            <button type="button" class="custom-btn custom-btn-secondary" data-bs-toggle="modal" data-bs-target="#notAllowedModal">
                                CONTINUE
                            </button>
                        </div>
                </div>
