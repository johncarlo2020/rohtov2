<x-app-layout>
    <div class="pledge-page main-content main-background with-scroll">
            ...
            <div class="mb-5 animate-entry delay-3">
                <div class="coral-selection-container w-100">
                    ...
                    <div class="coral-container w-100">
                        @for ($i = 1; $i <= 6; $i++) <div class="coral item-container" data-id="{{ $i }}">
                            <div class="coral-image-container">
                                ...
                                <img class="coral slick-img mx-auto"
                                    src="{{ asset('images/brand/coral/' . $i . '.webp') }}" alt="coral {{ $i }}" />
                            </div>
        ...
        <button id="selectCoralBtn" class="custom-btn custom-btn-secondary animate-entry delay-5 w-100">Select</button>
    </div>
    ...
    <script>
        ...
        const BUBBLE_FONT_SIZE = 120;
        const CORAL_FONT_SIZE = 60;
        const LINE_HEIGHT = 120; // line height for wrapped text
        ...
        function createBubbleCanvas(pledgeData, bubbleContainer) {
            ...
            async function drawBubble() {
                ...
                if (pledgeData.type === 'text') {
                    ctx.fillStyle = 'white';
                    ctx.font = `400 ${BUBBLE_FONT_SIZE}px "Forum", serif`;
                    ...
                    ctx.font = `400 ${CORAL_FONT_SIZE}px "Forum", serif`;
