    ...
    <main class="station-journey {{ $station->is_mandatory ? '' : 'is-reward' }}" id="station-journey"
        ...
        <footer class="station-journey-footer">
            <div id="station-start" @if($stationDone) hidden @endif>
                <button type="button" class="station-scan-button" aria-label="Scan station QR code"><i class="fa-solid fa-camera" aria-hidden="true"></i></button>
        ...
        <dialog class="station-result" aria-labelledby="station-result-message">
