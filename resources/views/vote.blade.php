    ...
    <div class="station-page main main-bg question-page brand-page">
        ...
        <div class="question">
            ...
            <div class="answers">
                @foreach ($brands as $brand)
                    <button onclick="checkAnswer(this)" class="shadow-sm item" data-id="{{ $brand->id }}"
                        style="">
                        {{ $brand->name }}
                        <img class="brand-img" src="{{ asset('images/brand' . $brand->id . '.png') }}"
                            alt="Lock Image" />
                    </button>
                @endforeach
            </div>
            ...
            <div class="mt-3 brand-btn">
                <button class="button" onclick="continueSelection()">
                    Continue
                </button>
            </div>
        ...
        <script>
            ...
            function sendMessage(id) {
                ...
                $.ajax({
                    url: '{{ route('castVote') }}', // Using Laravel's route() helper function
                    type: 'POST',
                    headers: {
                    ...
                    success: function(response) {
                        window.location.href = "{{ route('voteData') }}";
