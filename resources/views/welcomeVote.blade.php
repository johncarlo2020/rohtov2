...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased welcome-page">
        ...
        <div class="register-main">
            <a href="{{ route('vote') }}" class="home-btn btn rounded-pill"
                ><span>Vote</span></a
            >
            <a href="{{ route('register') }}" class="sign-btn btn rounded-pill"
                ><span>Sign Up</span></a
            >

            <a class="footer-text" href="https://wowsome.com.my/"
                >Powered by WOWSOME®2024</a
            >
        </div>
    </body>
</html>
