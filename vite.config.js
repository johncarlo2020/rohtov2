...
export default defineConfig({
    plugins: [
        laravel({
            input: ["resources/sass/app.scss", "resources/sass/dashboard.scss", "resources/js/app.js",'resources/js/argon-dashboard.js', 'resources/js/station.js', 'resources/sass/admin.scss' ,'resources/js/admin.js'],
            refresh: true,
        }),
    ],
    build: {
