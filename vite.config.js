...
export default defineConfig({
    plugins: [
        laravel({
            input: ["resources/sass/app.scss", "resources/sass/dashboard.scss", "resources/js/app.js", "resources/js/aquarium.js",'resources/js/argon-dashboard.js', 'resources/js/station.js', 'resources/sass/admin.scss'],
            refresh: true,
        }),
    ],
    build: {
